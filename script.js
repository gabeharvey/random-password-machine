...
function resPrompt() {
  passLength = parseInt(prompt("👋Hello!👋 We will generate a password for you using the Random Password Machine. Please choose your desired password length between 8 characters and 128 characters by entering number of characters in the box below 👇."));
